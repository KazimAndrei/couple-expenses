...
const ru = {
  ...
  'setup.start': 'Начать',
  'auth.appOnly': 'CoupleExpenses работает в приложении для iPhone — установи его, чтобы войти.',
  'invite.title': 'Тебя пригласили в пару',
  'invite.text': 'Установи CoupleExpenses на iPhone и введи этот код при входе — попадёшь в общий бюджет.',
  'invite.codeLabel': 'Код приглашения',
  'invite.openAppStore': 'Установить из App Store',
  ...
  'home.icon': 'Иконка',
  'home.color': 'Цвет',
  'home.editCategory': 'Категория',
  'home.deleteCategory': 'Удалить категорию',
  'home.deleteCategoryWarning': 'Категория «{name}» будет удалена. Траты по ней останутся, но без категории; бюджет по этой категории удалится.',
  'home.categoryUpdated': 'Категория обновлена',
  'home.categoryDeleted': 'Категория удалена',
  ...
  'analytics.income': 'Доход за месяц',
  'analytics.leftover': 'Осталось',
  'analytics.overspent': 'Перерасход',
  'analytics.spent': 'Потрачено',
  'analytics.saved': 'Отложено в цели',
  'analytics.noIncomeHint': 'Укажите доход на главной — и увидите, сколько остаётся после трат',
  ...
  'paywall.purchased': 'Подписка активна',
  'paywall.restored': 'Покупка восстановлена',
  'paywall.nothingToRestore': 'Покупок не найдено',
  'paywall.notActive': 'Подписка не активировалась',
  ...
  'profile.subRenews': 'продлится {date}',
  'profile.subUntil': 'до {date}',
  'profile.subGrace': 'Проблема с оплатой — проверьте способ оплаты',
  'profile.subExpired': 'Подписка истекла',
  'profile.subPaidByPartner': 'оплачивает партнёр',
  'paywall.title': 'Общий бюджет без споров',
  'paywall.subtitle': '7 дней бесплатно, потом подписка. Партнёр присоединяется бесплатно.',
  'paywall.f1': 'Общие траты с отметкой, кто платил',
  'paywall.f2': 'Цели-накопления вдвоём',
  'paywall.f3': 'Бюджеты по категориям и аналитика',
  'paywall.f4': 'Уведомления партнёру о тратах',
  'paywall.f5': 'Фото чеков, экспорт, Face ID',
  'paywall.yearly': 'Год',
  'paywall.monthly': 'Месяц',
  'paywall.per_year': 'год',
  'paywall.per_month': 'мес',
  'paywall.perMonth': '{price} в месяц',
  'paywall.save': 'Выгода 50%',
  'paywall.cta': 'Начать 7 дней бесплатно',
  'paywall.legal': 'Первые 7 дней бесплатно, далее подписка продлевается автоматически. Отменить можно в любой момент в настройках Apple ID.',
  ...
  'home.attachReceipt': 'Прикрепить чек',
  'home.receiptAttached': 'Чек: {name}',
  'home.viewReceipt': 'Открыть чек',
  'home.savedOffline': 'Нет сети — расход сохранён локально и отправится позже',
  'home.offlineSynced': 'Оффлайн-расходы отправлены',
  'common.on': 'Вкл',
  'common.off': 'Выкл',
  'boot.locked': 'Приложение заблокировано',
  'boot.unlock': 'Разблокировать',
  'profile.currencyChangeWarning': 'Записи, созданные в другой валюте, останутся в ней и не попадут в общие суммы',
  'profile.biometricLabel': 'Face ID:',
...
const en = {
  ...
  'auth.appOnly': 'CoupleExpenses works in the iPhone app — install it to sign in.',
  'invite.title': 'You have been invited',
  'invite.text': 'Install CoupleExpenses on your iPhone and enter this code to join the shared budget.',
  'invite.codeLabel': 'Invite code',
  'invite.openAppStore': 'Get it on the App Store',
  ...
  'home.icon': 'Icon',
  'home.color': 'Color',
  'home.editCategory': 'Category',
  'home.deleteCategory': 'Delete category',
  'home.deleteCategoryWarning': 'The “{name}” category will be deleted. Its expenses stay but lose the category, and its budget is removed.',
  'home.categoryUpdated': 'Category updated',
  'home.categoryDeleted': 'Category deleted',
  ...
  'analytics.income': 'Income this month',
  'analytics.leftover': 'Left',
  'analytics.overspent': 'Overspent',
  'analytics.spent': 'Spent',
  'analytics.saved': 'Into goals',
  'analytics.noIncomeHint': 'Set your income on the home screen to see what is left after spending',
  ...
  'paywall.purchased': 'Subscription active',
  'paywall.restored': 'Purchase restored',
  'paywall.nothingToRestore': 'No purchases found',
  'paywall.notActive': 'Subscription did not activate',
  ...
  'profile.subRenews': 'renews {date}',
  'profile.subUntil': 'until {date}',
  'profile.subGrace': 'Billing issue — check your payment method',
  'profile.subExpired': 'Subscription expired',
  'profile.subPaidByPartner': 'paid by your partner',
  'paywall.title': 'Shared money, zero arguments',
  'paywall.subtitle': '7 days free, then subscription. Your partner joins for free.',
  'paywall.f1': 'Every shared expense, and who paid it',
  'paywall.f2': 'Savings goals for the two of you',
  'paywall.f3': 'Category budgets and analytics',
  'paywall.f4': 'Instant notifications to your partner',
  'paywall.f5': 'Receipt photos, CSV export, Face ID',
  ...
  'paywall.legal': 'Free for 7 days, then the subscription renews automatically. Cancel anytime in your Apple ID settings.',
  ...
  'home.receiptAttached': 'Receipt: {name}',
  'home.viewReceipt': 'View receipt',
  'home.savedOffline': 'No connection — expense saved locally and will sync later',
  'home.offlineSynced': 'Offline expenses synced',
  'common.on': 'On',
  'common.off': 'Off',
  'boot.locked': 'App is locked',
  'boot.unlock': 'Unlock',
  'profile.currencyChangeWarning': 'Records created in another currency stay in it and are excluded from totals',
  'profile.biometricLabel': 'Face ID:',
