...
const ru = {
  ...
  'home.splitLabel': 'Деление',
  'home.splitEqual': 'Пополам',
  'home.splitFullPayer': 'Платит {name}',
  'home.splitCustom': 'Свой %',
  'home.splitCustomPct': 'Доля плательщика, %',
  ...
  'home.settlementsTitle': 'История расчётов',
  'home.noSettlements': 'Расчётов ещё не было',
  'common.on': 'Вкл',
  'common.off': 'Выкл',
...
const en = {
  ...
  'home.splitLabel': 'Split',
  'home.splitEqual': '50/50',
  'home.splitFullPayer': '{name} pays',
  'home.splitCustom': 'Custom %',
  'home.splitCustomPct': 'Payer share, %',
  ...
  'home.settlementsTitle': 'Settlement history',
  'home.noSettlements': 'No settlements yet',
  'common.on': 'On',
  'common.off': 'Off',
